...
class PaymentHandler: NSObject {
    ...
    /// Use this funcion to check if the device suport the apple pay nor not.
    ...
    func shippingMethodCalculator() -> [PKShippingMethod] {
        ...
        let shippingStart = calender.date(byAdding: .day, value: 4, to: today)
        let shippingEnd = calender.date(byAdding: .day, value: 8, to: today)
        ...
        if let shippingEnd = shippingEnd , let shippingStart = shippingStart {
            ...
            shippingDelivery.detail = "Product sent to your address"
    ...
    func startPayment(products: [Product], total: Double, completion: @escaping PaymentCompletionHandler) {
        ...
        // Iterate over the products array, create a PKPaymentSummaryItem
        //for each and append to the paymentSummaryItems array.
        ...
        paymentRequest.countryCode = "GBP"
